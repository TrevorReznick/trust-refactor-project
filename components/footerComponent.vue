    ...
    <div class="container pt-lg-4 pb-4">
      ...
      <div class="row mb-5 pb-md-3 pb-lg-4">
        <div class="col-lg-6 mb-lg-0 mb-4">
          ...
          >
            <div class="mb-sm-0 mb-4 px-2">
              ...
              <ul class="nav flex-column mb-sm-4 mb-2">
                <li class="nav-item">
                  <a class="nav-link p-0 fw-normal" href="tel:4065550120"
                    ...
                    ></i
                    >via imera n. 25 - 92100 - Agrigento</a
                  >
                </li>
                <li class="nav-item mb-2">
                  <a
                    class="nav-link p-0 fw-normal"
                    href="salvatoredifalco1@gmail.com"
                    ><i class="fi-mail mt-n1 me-2 align-middle opacity-70"></i
                    >salvatoredifalco1@gmail.com</a
                  >
                </li>
                <li class="nav-item">
                  <a class="nav-link p-0 fw-normal" href="tel:4065550120"
              ...
              <div class="pt-2">
                <a
                  ...
                  href="https://www.facebook.com/immobiliaredifalco"
                  target="_blank"
                >
            ...
            <div class="mb-sm-0 mb-4 px-2">
              <h4 class="h5">Collegamenti veloci</h4>
              <ul class="nav flex-column">
                <li class="nav-item mb-2">
                  <nuxt-link
                    class="nav-link p-0 fw-normal"
                    to="/estates/vendita"
                    >Acquista un immobile</nuxt-link
                  >
                </li>
                <li class="nav-item mb-2">
                  <nuxt-link class="nav-link p-0 fw-normal" to="/estates/sell"
                    >Vendi un immobile</nuxt-link
                  >
                </li>
                <li class="nav-item mb-2">
                  <nuxt-link class="nav-link p-0 fw-normal" to="/estates/rent"
                    >Affitta un immobile</nuxt-link
                  >
                </li>
                <li class="nav-item mb-2">
                  <a class="nav-link p-0 fw-normal" href="#"
                    >Сalculate your property</a
                  >
                </li>
                <li class="nav-item mb-2">
                  <nuxt-link
                    class="nav-link p-0 fw-normal"
                    to="/estates/topoffers"
                    >Le migliori offerte</nuxt-link
                  >
                </li>
                <!--<li class="nav-item mb-2"><a class="nav-link p-0 fw-normal" href="#">Migliori </a></li>-->
              </ul>
            </div>
            <div class="px-2">
              <h4 class="h5">Agenzia</h4>
              <ul class="nav flex-column">
                <li class="nav-item mb-2">
                  <nuxt-link class="nav-link p-0 fw-normal" to="/about"
                    >Chi siamo</nuxt-link
                  >
                </li>
                <li class="nav-item mb-2">
                  <a class="nav-link p-0 fw-normal" href="#">Agenti</a>
                </li>
                <li class="nav-item mb-2">
                  <a class="nav-link p-0 fw-normal" href="#"
                    >Help &amp; support</a
                ...
                <li class="nav-item mb-2">
                  <a class="nav-link p-0 fw-normal" href="#">Contatti</a>
                </li>
                <li class="nav-item mb-2">
                  <a class="nav-link p-0 fw-normal" href="#">Novità</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="col-xl-5 col-lg-6 offset-xl-1">
          ...
          <article class="d-flex align-items-start" style="max-width: 640px">
            ...
            >
              <img
                class="rounded-3"
                src="../assets/img/real-estate/blog/th01.jpg"
                width="100"
                alt="Blog post"
              />
            </a>
            <div>
              ...
              <h5 class="mb-2 fs-base">
                <a class="nav-link" href="real-estate-blog-single.html"
                  >Your Guide to a Smart Apartment Searching</a
                >
              </h5>
              <p class="mb-2 fs-sm">
          ...
          <article class="d-flex align-items-start" style="max-width: 640px">
            <a
              ...
              ><img
                class="rounded-3"
                src="../assets/img/real-estate/blog/th02.jpg"
                width="100"
                alt="Blog post"
            /></a>
            <div>
              ...
              <h5 class="mb-2 fs-base">
                <a class="nav-link" href="real-estate-blog-single.html"
                  >Top 10 Ways to Refresh Your Space</a
                >
              </h5>
              <p class="mb-2 fs-sm">
      ...
      <!--
        <div class="bg-dark rounded-3">
          <div class="col-xxl-10 col-md-11 col-10 d-flex flex-md-row flex-column-reverse align-items-md-end align-items-center mx-auto px-0"><img class="flex-shrink-0 mt-md-n5 me-md-5" src="~assets/img/real-estate/illustrations/mobile.svg" width="240" alt="Finder mobile app">
