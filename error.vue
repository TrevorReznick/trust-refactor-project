          ...
          <div class="col-lg-4 order-lg-1 order-2 position-relative py-lg-0 py-5 text-lg-start text-center">
            ...
            <span class="position-absolute top-0 start-0 d-lg-none d-block w-100 h-100 zindex-1 bg-dark rounded-bottom-0 rounded-4"></span>
              ...
              <div class="position-relative zindex-5">
                ...
                <div class="pt-3">
                  <a class="btn btn-lg btn-primary w-sm-auto w-100 mb-3 me-sm-4" href="/">Vai alla Home</a>
                  <a class="btn btn-lg btn-outline-light w-sm-auto w-100 mb-3" href="real-estate-help-center.html">Visit help center</a>
                </div>
              </div>
            </div>
            <div class="col-lg-6 offset-lg-2 order-lg-2 order-1">
              <div class="ratio ratio-1x1 mx-auto" style="max-width: 636px;">
                <lottie-player :src="getImage" background="transparent" speed="1" loop autoplay></lottie-player>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  computed: {
    getImage() {
      return require("../public/json/animation-real-estate-404.json")
    }
  }
}
</script>